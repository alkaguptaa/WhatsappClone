...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("send_message")) {
            sendMsg = getIntent().getStringExtra("send_message");
            sendimage = getIntent().getStringExtra("send_image");
            funSendMessageFromFeed();
        }
    ...
    private void funSendMessageFromFeed() {
        MessageInputText.setText(sendMsg);
        SendMessage();
        sendImageFromFeed();
    }
                ...
                filePath.putFile(fileUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Message message = new Message(messagePushID, messageSenderID, myUrl, checker, messageReceiverID, saveCurrentTime, saveCurrentDate, fileUri.getLastPathSegment());
    ...
    private void SendMessage() {
        ...
        if (TextUtils.isEmpty(messageText)) {
            ...
            Message message = new Message(messagePushID, messageSenderID, messageText, "text", messageReceiverID, saveCurrentTime, saveCurrentDate, null);
    ...
    private void sendImageFromFeed() {
        String messageSenderRef = "Messages/" + messageSenderID + "/" + messageReceiverID;
        String messageReceiverRef = "Messages/" + messageReceiverID + "/" + messageSenderID;
        ...
        Message message = new Message(messagePushID, messageSenderID, sendimage, "image", messageReceiverID, saveCurrentTime, saveCurrentDate, null);
